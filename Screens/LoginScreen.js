        ...
        <View style={{ flex: 1, backgroundColor: 'blue' }}>
            ...
            >
                <View style={{
                    ...
                    <TextInput placeholder={'FirstName'} style={styles.textInput} placeholderTextColor='black' />
                    <TextInput placeholder={'LastName'} style={styles.textInput} placeholderTextColor='black' />
                    <TextInput placeholder={'Email'} style={styles.textInput} placeholderTextColor='black' />
                    <TextInput placeholder={'Contact'} style={styles.textInput} placeholderTextColor='black' />
                    <View style={{ paddingTop: 50, justifyContent: 'space-between' }}>
